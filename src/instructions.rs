...
pub enum InstType {
    ...
    I { imm: usize, rs1: usize, funct3: usize, rd: usize, opcode: usize },
    // S形式の命令 
    // | 31 ----- 25 | 24 --- 20 | 19 --- 15 | 14 --- 12 | 11 --- 7 | 6 --- 0 |
    //    imm[11:5]       rs2         rs1        funct3    imm[4:0]   opcode
    S { imm_1: usize, rs2: usize, rs1: usize, funct3: usize, imm_2: usize, opcode: usize },
}
